...
{
    [ApiController]
    // Specifies that this controller endpoint (the uri to reach it) is '/api/Example'
    ...
    public class ExampleController : ControllerBase
    {
        ...
        // This is due to it being registered in Dependecy Injection container (default behaviour of web api)
