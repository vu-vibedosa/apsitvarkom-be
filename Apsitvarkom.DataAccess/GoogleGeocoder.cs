...
public class GoogleGeocoder : IGeocoder
{
    ...
    {
        var jsonStream = await _httpClient.GetStreamAsync($"json?latlng={coordinates.Latitude},{coordinates.Longitude}&language=lt&result_type=point_of_interest&key={_apiKey}");
